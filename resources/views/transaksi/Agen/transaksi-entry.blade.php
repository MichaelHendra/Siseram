...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-body">
            ...
            <form action="{{ url('/transaksi/agen/store') }}" id="transaksi-form"class="form-horizontal row-border" method="POST">
                @csrf
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <button id="tambah-data"name="simpan" type="submit" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </div>
