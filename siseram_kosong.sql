...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Bulan Mei 2023 pada 15.05
...
--
ALTER TABLE `tb_stok`
  MODIFY `kode_stok` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_transaksi_detail`
--
ALTER TABLE `tb_transaksi_detail`
  MODIFY `kode_detail` int(255) NOT NULL AUTO_INCREMENT;
